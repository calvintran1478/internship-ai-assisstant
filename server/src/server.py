...
app.add_route("/api/v1/users/concentration", user_resource, suffix="concentration")
app.add_route("/api/v1/chats", chat_resource)
app.add_route("/api/v1/chats/{chat_id:uuid}", chat_resource, suffix="chat")
